...
class BeneficiaryAccountService extends Caliza
{
    public function create($payload)
    {
        ...
        try {
            ...
            $response = $this->caliza()->post(CALIZA_CREATE_BENEFICIARY_ENDPOINT, $payload);
            ...
            ExternalServiceLogger::create("{$this->base_url}" . CALIZA_CREATE_BENEFICIARY_ENDPOINT, $payload, $data, $code, MODULE_CALIZA);
