...
class QuoteService extends Caliza
{
    public function create($payload)
    {
        ...
        try {
            ...
            $response = $this->caliza()->post(CALIZA_SIMULATE_PAYOUT_ENDPOINT, $payload);
            ...
            ExternalServiceLogger::create("{$this->base_url}" . CALIZA_SIMULATE_PAYOUT_ENDPOINT, $payload, $data, $code, MODULE_CALIZA);
